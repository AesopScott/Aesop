...
**Generated:** 2026-09-12 14:09 UTC  
**Status:** 🔴 ISSUES FOUND  
**Errors:** 1 · **Warnings:** 29

**Notes:**
- electives-hub.html has no `BASE_COURSES` block; it loads live courses dynamically from `course-registry.json` at runtime (registry-only mode). Hub-directory and hub-in-registry checks reduce to the registry checks in R-1/R-2.
...
- Electives hub courses (registry-only): 128
