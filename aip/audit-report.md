...
**Generated:** 2026-06-02 14:10 UTC  
**Status:** 🔴 ISSUES FOUND  
...
ℹ️ `electives-hub.html` is registry-driven (v1.1+); no hardcoded `BASE_COURSES` to audit. Course data is loaded at runtime from `course-registry.json`.
