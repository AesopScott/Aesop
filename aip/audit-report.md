...
**Generated:** 2026-05-31 14:10 UTC  
**Status:** 🔴 ISSUES FOUND  
...
- courses.html course refs (`?course=`): 123
- Electives hub courses: 109 (source: JSON-LD ItemList (?course= params; BASE_COURSES array not present — hub is registry-driven per v1.1.0))
