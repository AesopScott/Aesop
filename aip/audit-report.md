...
**Generated:** 2026-05-30 14:09 UTC
**Status:** 🔴 ISSUES FOUND
...
## Electives Hub (electives-hub.html) — registry-driven mode

✅ No issues found.

*Note: `electives-hub.html` declares registry-only mode (no hardcoded `BASE_COURSES` array); H-1, H-2, X-2, and X-3 checks are skipped because the hub renders every registry course at runtime.*
