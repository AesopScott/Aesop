...
define('AZURE_CLIENT_ID',     '');           // Application (client) ID
define('AZURE_CLIENT_SECRET', '');           // Client secret value
define('AZURE_TENANT_ID',     '');           // Directory (tenant) ID
...
define('OWNER_TIMEZONE', 'America/Chicago');  // your timezone
